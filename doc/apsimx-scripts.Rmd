...
In Windows it is better to use 'shell' from R.
...
**/Applications/APSIM2019.06.25.3956.app**
...
**mono /Applications/APSIM2019.06.25.3956.app/Contents/Resources/Bin/Models.exe ./Wheat.apsimx**

Debian:

**mono /usr/local/lib/apsim/2019.06.25.3956/Bin/Models.exe ./Wheat.apsimx**

The previous two commands assume that the file "Wheat.apsimx" is present in the current working directory. A detailed that seems to have changed with recent versions of 'mono' (not sure) is that if you just use the name of a file, it will return an error saying that empty paths are not valid. So this did not work on Debian:
