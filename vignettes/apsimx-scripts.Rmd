...
If you are using a previous version of APSIM (7.x) you might be interested in either the 'APSIM' or 'apsimr' R packages.
...
**C:\\Program Files\\APSIM2019.07.19.4025\\Bin\\Models.exe**

Notice that for each new build of APSIM-X the path will change. After 'APSIM' is the year, month, date and version separated by a period. In this case '2019.07.19.4000'. In the folder 'Bin'(for 'binary') there are many libraries ('.dll files') and some executables. The 'Models.exe' is the one that can run .apsimx files.
...
**C:/PROGRA~1/APSIM2019.07.19.4025/Bin/Models.exe** or

**C:\\\\PROGRA~1\\\\APSIM2019.07.19.4025\\\\Bin\\\\Models.exe**
...
**C:/PROGRA~1/APSIM2019.07.19.4025/Bin/Models.exe ./Wheat.apsimx**.

However, the previous string cannot be passed directly to a Windows shell. It needs to be translated, because the 'PROGRA~1' needs to be expanded and the forward slashes ("/") need to be converted to backslashes ("\\").
...
Note: it seems that, in Windows, it is only possible to run files in the current directory. So, for example, if the file 'Wheat.apsimx' was in subdirectory './myApsimXsimulations' and you want to replace the './Wheat.apsimx' above with './myApsimXsimulations/Wheat.apsimx' this does not work. I do not know if there is a possible workaround. 
...
**/Applications/APSIM2019.07.25.4035.app**

Debian:

apsim lib: **/usr/local/lib/apsim/2019.07.09.4000**
...
**mono /Applications/APSIM2019.07.25.4035.app/Contents/Resources/Bin/Models.exe ./Wheat.apsimx**

Debian:

**mono /usr/local/lib/apsim/2019.07.09.4000/Bin/Models.exe ./Wheat.apsimx**
...
Running APSIM-X command line (Mac): https://www.apsim.info/Support/tabid/254/forumid/1/threadid/2312/scope/posts/Default.aspx
...
https://www.apsim.info/Documentation/TechnicalandDevelopment/RunAPSIMfromcommandlineorfromscripts.aspx
